...
const About = () => {
  return (
    <div id='about' className=' flex flex-col bg-[#f2ece4] md:flex-row items-center justify-around px-4 py-8 md:py-32 md:px-20'>
      ...
      <div className=" md:w-1/2 mt-8 md:mt-0 md:pl-8 text-center md:text-left">
        <h2 className="relative text-3xl md:text-5xl font-[600] pb-4 text-black">
          About Us
        </h2>
